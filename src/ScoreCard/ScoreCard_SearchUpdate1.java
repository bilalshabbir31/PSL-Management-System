 ...
 */
public class ScoreCard_SearchUpdate1 extends javax.swing.JFrame {
    ...
    public ScoreCard_SearchUpdate1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(search);
        search.setBounds(480, 360, 140, 50);
        ...
        jLabel3.setText("Update ScoreCard");
        jPanel1.add(jLabel3);
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        if(check==true){
            try{
                ...
                PreparedStatement preparedStatement=Connection.prepareStatement("select * from TeamMatch where MatchId=?"); 
                preparedStatement.setString(1, s);
                ResultSet objset=preparedStatement.executeQuery();
                if(objset!=null &&objset.next()){
                    TeamMatch T=new TeamMatch(objset.getString(1),objset.getString(2),objset.getString(3),objset.getString(4));
                    RunNextFrame(T);
                }
            }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScoreCard_SearchUpdate1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    boolean Check_ID(String s){
        ...
        try{
            Connection=objConnectivity.getConnection();
            String Query="Select * from ScoreCard where Match_id=?";
