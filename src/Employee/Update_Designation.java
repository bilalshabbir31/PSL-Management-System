 ...
 */
public class Update_Designation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AddDesignation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PSL Icon/icons8-update-48.png"))); // NOI18N
        AddDesignation.setText("Update");
    ...
    private void AddDesignationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddDesignationActionPerformed
        if(!(this.id.getText().isEmpty()&&name.getText().isEmpty())){
            ...
            if(check==true){
                ...
                JOptionPane.showMessageDialog(this,"Sorry id is Doesn't Exists! ");
            }
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Designation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
